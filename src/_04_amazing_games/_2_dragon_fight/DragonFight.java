	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			JOptionPane.showMessageDialog(null,
					"the player has" + playerhealth + " health the dragon has" + dragonhealth + "health");
			// 9. If the player's health is less than or equal to 0, the game is over,
			// call the playerLost() method
			String Input2 = JOptionPane.showInputDialog("would you like to heal or attack");

			if (Input2.contains("heal")) {
				playerheal = ran.nextInt(20);
